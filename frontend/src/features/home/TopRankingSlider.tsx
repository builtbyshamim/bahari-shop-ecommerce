...
interface TopRankingSliderProps {
  products: any[];
}

const TopRankingSlider = ({ products }: TopRankingSliderProps) => {
  ...
  return (
    <div className="py-3 relative group/swiper overflow-hidden">
      ...
      <style jsx global>{`
        ...
        .top-ranking-swiper .swiper-slide {
          transition: transform 0.3s ease;
        }

        .top-ranking-swiper .swiper-slide:hover {
