...
const EditBlog = () => {
  ...
  const { data: blogRes, isLoading: isFetchingBlog } = useGetBlogByIdQuery(id!);
  ...
  useEffect(() => {
    if (blog) {
      ...
      if (blog.product) {
        ...
        setProductSearch(blog.product.name);
      }
    }
  }, [blog, reset]);
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const result = await updateBlog({ id: id!, data: formData }).unwrap();
    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5 truncate max-w-md">{blog?.title}</p>
        </div>
      </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
              ...
              <ToggleSwitch
                ...
                register={register}
                errors={errors}
                defaultValue={blog?.isPublished ?? true}
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              {thumbnailPreview ? (
                <div className="relative">
                  ...
                  <label className="mt-2 flex items-center gap-2 text-xs text-primary-500 cursor-pointer hover:underline">
                    <input
                      type="file"
                      accept="image/*"
